  ...
  <div class="container is-flex is-justify-content-space-between is-align-items-center">
    <div class="navbar-brand">
      <a href="./MainPage.jsp" class="navbar-brand">
        <img src="/resources/img/zandiLogo.jpg" alt="ZANDI Logo">
      </a>
    </div>
    <div class="buttons">
      <c:if test="${loginID == null}">
        <div class="project_button mr-2">
          <a href="/zandiBookmark/addProjectForm.jsp" class="button is-small">프로젝트 올리기</a>
        </div>
        <div class="login_button">
          <a href="/zandiaccount/login.jsp" class="button is-small">로그인 / 회원가입</a>
        </div>
      </c:if>
      <c:if test="${loginID != null}">
        <div class="project_button mr-2">
        ...
        <div class="MyPage_button mr-2">
          <a href="/zandiaccount/myPage.jsp" class="button is-small">마이페이지</a>
        </div>
        <div class="logout_button">
          <a href="/zandiaccount/logout.jsp" class="button is-small">로그아웃</a>
        </div>
      </c:if>
    </div>
  </div>
...
<nav class="navbar is-white second-navbar">
  <div class="container is-flex is-justify-content-space-between is-align-items-center">
